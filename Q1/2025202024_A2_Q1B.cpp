...
int main(){
    ...
    cout << "1 for Enqeue an item " << endl;
    cout << "2 for Dequeue-- it will remove and return a random item " << endl; 
    cout << "3 for sample -- it will return a random item with out removing it form the queue." << endl;
    ...
    while(true){
        ...
        if(flag == 1){
            int number;
            cout << "enter the number which you want to include in the queue" << endl;
            cin >> number;
            rq.enqueue(number);
        }
        else if(flag == 2){
            if (!rq.empty()) {
                cout << "Dequeued random item: " << rq.dequeue() << endl;
            } 
            else {
            ...
            if (!rq.empty()) {
                cout << "sample random item: " << rq.sample() << endl;
            } 
            else {
                cout << "Queue is empty." << endl;
            }
            ...
            cout << "ecit program is requested" << endl;
            break;
        }
        else{
